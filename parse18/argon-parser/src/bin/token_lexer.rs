...
fn main() {
    ...
    b.add(Regex::str("loop"), "TokenType.Token(Token.KW_LOOP)");
    b.add(Regex::str("while"), "TokenType.Token(Token.KW_WHILE)");
    b.add(Regex::str("break"), "TokenType.Token(Token.KW_BREAK)");
    b.add(Regex::str("next"), "TokenType.Token(Token.KW_NEXT)");
    b.add(Regex::str("redo"), "TokenType.Token(Token.KW_REDO)");
