...
object ArgonExprContext {
  ...
  def convertArExpr[F[+_]: Monad](
    ...
    def convertClassConstructorCallArgs(ctor: ec2.ExprConstructor { type ConstructorArgs = ec2.ExprConstructor.ClassConstructorCallArgs })(args: ec1.ExprConstructor.ClassConstructorCallArgs): F[ec2.ArExpr[ec2.ExprConstructor]] =
    ...
    def convertVectorArgs(ctor: ec2.ExprConstructor { type ConstructorArgs = Vector[ec2.WrapExpr] })(args: Vector[ec1.WrapExpr]): F[ec2.ArExpr[ec2.ExprConstructor]] =
      for {
        args2 <- Traverse[Vector].traverse(args)(convertWrapExpr(context)(ec1, ec2)(f))
      } yield ec2.ArExpr(ctor, args2)

    def convertNonEmptyListArgs(ctor: ec2.ExprConstructor { type ConstructorArgs = NonEmptyList[ec2.WrapExpr] })(args: NonEmptyList[ec1.WrapExpr]): F[ec2.ArExpr[ec2.ExprConstructor]] =
      for {
        args2 <- Traverse[NonEmptyList].traverse(args)(convertWrapExpr(context)(ec1, ec2)(f))
      } yield ec2.ArExpr(ctor, args2)

    def convertMethodCallArgs(ctor: ec2.ExprConstructor { type ConstructorArgs = ec2.ExprConstructor.MethodCallArgs })(args: ec1.ExprConstructor.MethodCallArgs): F[ec2.ArExpr[ec2.ExprConstructor]] =
    ...
    def convertPatternMatchArgs[N <: Nat](ctor: ec2.ExprConstructor { type ConstructorArgs = ec2.ExprConstructor.PatternMatchArgs[N] })(args: ec1.ExprConstructor.PatternMatchArgs[N]): F[ec2.ArExpr[ec2.ExprConstructor]] =
      val (obj, cases) = args
      for {
    ...
    def convertExprArgs(ctor: ec2.ExprConstructor { type ConstructorArgs = ec2.WrapExpr })(args: ec1.WrapExpr): F[ec2.ArExpr[ec2.ExprConstructor]] =
      for {
        args2 <- convertWrapExpr(context)(ec1, ec2)(f)(args)
      } yield ec2.ArExpr(ctor, args2)

    def convertPairArgs(ctor: ec2.ExprConstructor { type ConstructorArgs = (ec2.WrapExpr, ec2.WrapExpr) })(args: (ec1.WrapExpr, ec1.WrapExpr)): F[ec2.ArExpr[ec2.ExprConstructor]] =
      val (a1, b1) = args
      for {
    ...
    def convertTuple3Args(ctor: ec2.ExprConstructor { type ConstructorArgs = (ec2.WrapExpr, ec2.WrapExpr, ec2.WrapExpr) })(args: (ec1.WrapExpr, ec1.WrapExpr, ec1.WrapExpr)): F[ec2.ArExpr[ec2.ExprConstructor]] =
      val (a1, b1, c1) = args
      for {
        a2 <- convertWrapExpr(context)(ec1, ec2)(f)(a1)
        b2 <- convertWrapExpr(context)(ec1, ec2)(f)(b1)
