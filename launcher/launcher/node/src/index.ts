...
function convertCommand(options: DriverCommand<string, string, string, string>): DriverCommand<BinaryResource<Error>, DirectoryResource<Error>, BinaryResourceSink<Error>, DirectoryResourceSink<Error>> {
    switch (options.$type) {
        case "help-command":
