...
# Build
cargo zigbuild -p argon-cli --release --target x86_64-unknown-linux-gnu.2.17
cargo zigbuild -p argon-cli --release --target i686-unknown-linux-gnu.2.17
cargo zigbuild -p argon-cli --release --target aarch64-unknown-linux-gnu.2.17
cargo build -p argon-cli --release --target x86_64-pc-windows-gnu
cargo build -p argon-cli --release --target i686-pc-windows-gnu
