...
(function (V1) {
    V1.codec = {
        async read(reader) {
            return { id: await sym_int.codec.read(reader), arguments: await sym_list.codec(sym_argon_tube_Expression.V1.codec).read(reader), };
        },
        async write(writer, value) {
            await sym_int.codec.write(writer, value.id);
            await sym_list.codec(sym_argon_tube_Expression.V1.codec).write(writer, value.arguments);
        },
    };
})(V1 || (V1 = {}));
