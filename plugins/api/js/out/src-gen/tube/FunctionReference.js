...
(function (V1) {
    V1.codec = {
        async read(reader) {
            return { owner: await sym_argon_tube_FunctionOwner.V1.codec(sym_nat.codec).read(reader), name: await sym_option.codec(sym_argon_tube_Identifier.V1.codec).read(reader), signature: await sym_argon_tube_ErasedSignature.V1.codec.read(reader), };
        },
        async write(writer, value) {
            await sym_argon_tube_FunctionOwner.V1.codec(sym_nat.codec).write(writer, value.owner);
...
//# sourceMappingURL=FunctionReference.js.map