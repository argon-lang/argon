...
fn erase_builtin(context: &Context, builtin: Builtin<DefaultExprContext>) -> ErasedSignatureType {
    match builtin {
        Builtin::IntType { integer_type } => match integer_type {
            ...
            IntegerType::I16 => ErasedSignatureType::I16,
            IntegerType::U16 => ErasedSignatureType::U16,
            IntegerType::I32 => ErasedSignatureType::I32,
            IntegerType::U32 => ErasedSignatureType::U32,
            IntegerType::I64 => ErasedSignatureType::I64,
            IntegerType::U64 => ErasedSignatureType::U64,
        },
