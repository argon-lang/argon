...
final class DummyTypeSystem extends TypeSystemUnerased {
  ...
  override def fromTypeBase(typeBase: TypeBase[DummyTypeSystem.this.type]): TypeBase[DummyTypeSystem.this.type] =
    typeBase

  val comparer: TypeComparer[this.type] = new TypeComparerUnerased[this.type] {
