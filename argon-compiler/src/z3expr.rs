...
> Z3Expr<'z3, EC>
{
        ...
        match &t.value {
            Expr::Builtin(Builtin::IntType { integer_type }) => {
                let tester = match integer_type {
                    ...
                    IntegerType::I32 => &self.argon_value_sort.value_testers.i32_literal,
                    IntegerType::U32 => &self.argon_value_sort.value_testers.u32_literal,
                    IntegerType::I64 => &self.argon_value_sort.value_testers.i64_literal,
                    IntegerType::U64 => &self.argon_value_sort.value_testers.u64_literal,
                };
    ...
    fn assert_argon_value_constructor_axioms(&self) {
        ...
        self.assert_value_constructor_axiom(
            "u32_literal",
            &sort.value_constructors.u32_literal,
        ...
        self.assert_value_constructor_axiom(
            "i32_literal",
            &sort.value_constructors.i32_literal,
        ...
        self.assert_value_constructor_axiom(
            "u64_literal",
            &sort.value_constructors.u64_literal,
        ...
        self.assert_value_constructor_axiom(
            "i64_literal",
            &sort.value_constructors.i64_literal,
            ...
            Expr::Builtin(builtin) => match builtin {
                Builtin::IntNegate {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self.i32_literal_value(&value).bvneg();
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self.u32_literal_value(&value).bvneg();
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self.i64_literal_value(&value).bvneg();
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self.u64_literal_value(&value).bvneg();
                ...
                Builtin::IntBitNot {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self.i32_literal_value(&value).bvnot();
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self.u32_literal_value(&value).bvnot();
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self.i64_literal_value(&value).bvnot();
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self.u64_literal_value(&value).bvnot();
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                ...
                                .bvadd(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvadd(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvadd(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvadd(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                Builtin::IntSub {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                .i32_literal_value(&lhs)
                                .bvsub(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvsub(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvsub(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvsub(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                Builtin::IntMul {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                .i32_literal_value(&lhs)
                                .bvmul(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvmul(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvmul(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvmul(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                Builtin::IntBitAnd {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                .i32_literal_value(&lhs)
                                .bvand(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvand(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvand(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvand(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                Builtin::IntBitOr {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                .i32_literal_value(&lhs)
                                .bvor(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvor(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvor(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvor(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                Builtin::IntBitXor {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                .i32_literal_value(&lhs)
                                .bvxor(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvxor(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvxor(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvxor(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                Builtin::IntBitShiftLeft {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                .i32_literal_value(&lhs)
                                .bvshl(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvshl(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvshl(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvshl(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                Builtin::IntBitShiftRight {
                    ...
                    match integer_type {
                        ...
                        IntegerType::I32 => {
                            let value = self
                                .i32_literal_value(&lhs)
                                .bvashr(&self.i32_literal_value(&rhs));
                            Some(self.wrap_i32_literal(&value))
                        }
                        IntegerType::U32 => {
                            let value = self
                                .u32_literal_value(&lhs)
                                .bvlshr(&self.u32_literal_value(&rhs));
                            Some(self.wrap_u32_literal(&value))
                        }
                        IntegerType::I64 => {
                            let value = self
                                .i64_literal_value(&lhs)
                                .bvashr(&self.i64_literal_value(&rhs));
                            Some(self.wrap_i64_literal(&value))
                        }
                        IntegerType::U64 => {
                            let value = self
                                .u64_literal_value(&lhs)
                                .bvlshr(&self.u64_literal_value(&rhs));
                            Some(self.wrap_u64_literal(&value))
                        }
                    }
                }
                ...
                Builtin::IntLt {
                    ...
                    let value = match integer_type {
                        ...
                        IntegerType::I32 => self
                            .i32_literal_value(&lhs)
                            .bvslt(&self.i32_literal_value(&rhs)),
                        IntegerType::U32 => self
                            .u32_literal_value(&lhs)
                            .bvult(&self.u32_literal_value(&rhs)),
                        IntegerType::I64 => self
                            .i64_literal_value(&lhs)
                            .bvslt(&self.i64_literal_value(&rhs)),
                        IntegerType::U64 => self
                            .u64_literal_value(&lhs)
                            .bvult(&self.u64_literal_value(&rhs)),
                    };
                    Some(self.wrap_bool_literal(&value))
                }
                Builtin::IntLe {
                    ...
                    let value = match integer_type {
                        ...
                        IntegerType::I32 => self
                            .i32_literal_value(&lhs)
                            .bvsle(&self.i32_literal_value(&rhs)),
                        IntegerType::U32 => self
                            .u32_literal_value(&lhs)
                            .bvule(&self.u32_literal_value(&rhs)),
                        IntegerType::I64 => self
                            .i64_literal_value(&lhs)
                            .bvsle(&self.i64_literal_value(&rhs)),
                        IntegerType::U64 => self
                            .u64_literal_value(&lhs)
                            .bvule(&self.u64_literal_value(&rhs)),
                    };
                    Some(self.wrap_bool_literal(&value))
                }
                Builtin::IntGt {
                    ...
                    let value = match integer_type {
                        ...
                        IntegerType::I32 => self
                            .i32_literal_value(&lhs)
                            .bvsgt(&self.i32_literal_value(&rhs)),
                        IntegerType::U32 => self
                            .u32_literal_value(&lhs)
                            .bvugt(&self.u32_literal_value(&rhs)),
                        IntegerType::I64 => self
                            .i64_literal_value(&lhs)
                            .bvsgt(&self.i64_literal_value(&rhs)),
                        IntegerType::U64 => self
                            .u64_literal_value(&lhs)
                            .bvugt(&self.u64_literal_value(&rhs)),
                    };
                    Some(self.wrap_bool_literal(&value))
                }
                Builtin::IntGe {
                    ...
                    let value = match integer_type {
                        ...
                        IntegerType::I32 => self
                            .i32_literal_value(&lhs)
                            .bvsge(&self.i32_literal_value(&rhs)),
                        IntegerType::U32 => self
                            .u32_literal_value(&lhs)
                            .bvuge(&self.u32_literal_value(&rhs)),
                        IntegerType::I64 => self
                            .i64_literal_value(&lhs)
                            .bvsge(&self.i64_literal_value(&rhs)),
                        IntegerType::U64 => self
                            .u64_literal_value(&lhs)
                            .bvuge(&self.u64_literal_value(&rhs)),
                    };
                    Some(self.wrap_bool_literal(&value))
                }
    ...
    fn fixed_integer_literal_value(
        ...
        match integer_type {
            ...
            IntegerType::I32 => self.i32_literal_value(value),
            IntegerType::U32 => self.u32_literal_value(value),
            IntegerType::I64 => self.i64_literal_value(value),
            IntegerType::U64 => self.u64_literal_value(value),
    ...
    fn fixed_integer_is_signed(integer_type: IntegerType) -> bool {
        match integer_type {
            ...
            IntegerType::I32 | IntegerType::I64 => true,
            IntegerType::U32 | IntegerType::U64 => false,
            IntegerType::Int => panic!("int is not a fixed-width integer"),
        }
    }
    ...
    fn wrap_fixed_integer_literal(
        ...
        match integer_type {
            ...
            IntegerType::I32 => self.wrap_i32_literal(value),
            IntegerType::U32 => self.wrap_u32_literal(value),
            IntegerType::I64 => self.wrap_i64_literal(value),
            IntegerType::U64 => self.wrap_u64_literal(value),
            IntegerType::Int => panic!("int is not a fixed-width integer"),
        }
    }
...
impl<'z3> ArgonValueSort<'z3> {
    ...
    pub fn new(context: &'z3 Z3Context) -> Self {
        ...
        let value_testers = ArgonValueTesters {
            ...
            i32_literal: tester("argon_value_is_i32_literal", &value),
            u32_literal: tester("argon_value_is_u32_literal", &value),
            i64_literal: tester("argon_value_is_i64_literal", &value),
            u64_literal: tester("argon_value_is_u64_literal", &value),
    ...
    fn value_tester_terms(&self, value: &impl Ast<'z3>) -> Vec<Bool<'z3>> {
        [
            ...
            &self.value_testers.i32_literal,
            &self.value_testers.u32_literal,
            &self.value_testers.i64_literal,
            &self.value_testers.u64_literal,
...
mod tests {
    ...
    fn bool_var() -> Variable<DefaultExprContext> {
        Variable::Local(Box::new(argon_expr::LocalVariable {
            ...
            name: None,
            var_type: located(Expr::bool_type()),
    ...
    fn located(expr: Expr<DefaultExprContext>) -> LocatedExpr<DefaultExprContext> {
        expr.with_location(location())
    }

    fn int_expr(value: i64) -> LocatedExpr<DefaultExprContext> {
        located(Expr::IntLiteral(value.into()))
    }

    fn string_expr(value: &str) -> LocatedExpr<DefaultExprContext> {
        located(Expr::StringLiteral(value.into()))
    }

    fn bool_expr(value: bool) -> LocatedExpr<DefaultExprContext> {
    ...
    fn int_builtin_operations_use_z3_int_operations() {
        ...
        let add = z3expr.expr_to_z3(&located(Expr::Builtin(Builtin::IntAdd {
            integer_type: IntegerType::Int,
            lhs: Box::new(int_expr(1)),
            rhs: Box::new(int_expr(2)),
        })));
    ...
    fn int_comparison_builtins_use_z3_int_comparisons() {
        ...
        let le = z3expr.expr_to_z3(&located(Expr::Builtin(Builtin::IntLe {
            integer_type: IntegerType::Int,
            lhs: Box::new(int_expr(1)),
            rhs: Box::new(int_expr(2)),
        })));
        ...
        let gt = z3expr.expr_to_z3(&located(Expr::Builtin(Builtin::IntGt {
            integer_type: IntegerType::Int,
        ...
        let ge = z3expr.expr_to_z3(&located(Expr::Builtin(Builtin::IntGe {
            integer_type: IntegerType::Int,
            lhs: Box::new(int_expr(2)),
            rhs: Box::new(int_expr(1)),
        })));
    ...
    fn boolean_logical_operators_use_z3_bool_operations() {
        ...
        let b_expr = located(Expr::Variable(b));
        ...
        let actual_and = z3expr.expr_to_z3(&located(Expr::And(
        ...
        let actual_or = z3expr.expr_to_z3(&located(Expr::Or(
            Box::new(a_expr.clone()),
            Box::new(b_expr.clone()),
        )));
        ...
        let actual_not = z3expr.expr_to_z3(&located(Expr::Not(Box::new(a_expr))));
    ...
    fn inhabited_reduces_structural_type_rules() {
        ...
        let rhs = located(Expr::Builtin(Builtin::BoolType));
        let lhs_inhabited = z3expr.inhabited(&lhs);
        let rhs_inhabited = z3expr.inhabited(&rhs);

        let conjunction = z3expr.inhabited(&located(Expr::ConjunctionType {
            lhs: Box::new(lhs.clone()),
            rhs: Box::new(rhs.clone()),
        }));
        assert_eq!(Bool::and(&[&lhs_inhabited, &rhs_inhabited]), conjunction);

        let disjunction = z3expr.inhabited(&located(Expr::DisjunctionType {
            lhs: Box::new(lhs.clone()),
            rhs: Box::new(rhs.clone()),
        }));
        assert_eq!(Bool::or(&[&lhs_inhabited, &rhs_inhabited]), disjunction);

        let function_type = z3expr.inhabited(&located(Expr::FunctionType {
