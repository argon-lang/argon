...
public final class ExternGeneratorSupport {
	...
	public static byte[] staticExternMethodClass(ClassDesc className, int classFlags, String externName, String methodName,
		MethodTypeDesc descriptor, Consumer<CodeBuilder> body) {
	...
	private static byte[] staticExternClass(ClassDesc className, int classFlags,
		RuntimeInvisibleAnnotationsAttribute annotation, String methodName,
		MethodTypeDesc descriptor, Consumer<CodeBuilder> body) {
