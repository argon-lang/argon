...
export function createBackend<E, A>(_errorChecker_e: ErrorChecker<E>, f: <Output, Options>(backend: backendApi.Backend<E, Output, Options>) => A): A {
