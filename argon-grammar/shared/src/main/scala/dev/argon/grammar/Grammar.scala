...
sealed trait Grammar[TToken, TSyntaxError, TLabel[_], +T] {
  ...
  def parseTokens(tokens: NonEmptyChunk[WithSource[TToken]], options: TParseOptions): GrammarResult[TToken, TSyntaxError, TLabel, T]
...
object Grammar {
  ...
  sealed trait GrammarResult[TToken, TSyntaxError, TLabel[_], +T] {
    def map[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => (Chunk[WithSource[TToken]], WithSource[U])): GrammarResult[TToken, TSyntaxError, TLabel, U]
    def flatMap[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => GrammarResult[TToken, TSyntaxError, TLabel, U]): GrammarResult[TToken, TSyntaxError, TLabel, U]

    def treatFailureAsError: GrammarResult[TToken, TSyntaxError, TLabel, T]

    def recoverFailure[U >: T](f: (Chunk[WithSource[TToken]], GrammarResultFailure[TToken, TSyntaxError, TLabel]) => GrammarResult[TToken, TSyntaxError, TLabel, U]): GrammarResult[TToken, TSyntaxError, TLabel, U]
  ...
  sealed trait GrammarResultComplete[TToken, TSyntaxError, TLabel[_], +T] extends GrammarResult[TToken, TSyntaxError, TLabel, T] {
    ...
    def flatMap[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => GrammarResultComplete[TToken, TSyntaxError, TLabel, U]): GrammarResultComplete[TToken, TSyntaxError, TLabel, U]


    override def map[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => (Chunk[WithSource[TToken]], WithSource[U])): GrammarResultComplete[TToken, TSyntaxError, TLabel, U]
    override def flatMap[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => GrammarResult[TToken, TSyntaxError, TLabel, U]): GrammarResult[TToken, TSyntaxError, TLabel, U]
  ...
  final case class GrammarResultSuccess[TToken, TSyntaxError, TLabel[_], +T](tokens: Chunk[WithSource[TToken]], value: WithSource[T]) extends GrammarResultComplete[TToken, TSyntaxError, TLabel, T] {
    override def map[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => (Chunk[WithSource[TToken]], WithSource[U])): GrammarResultComplete[TToken, TSyntaxError, TLabel, U] =
    ...
    override def flatMap[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => GrammarResultComplete[TToken, TSyntaxError, TLabel, U]): GrammarResultComplete[TToken, TSyntaxError, TLabel, U] =
      f(tokens, value)

    override def treatFailureAsError: GrammarResultComplete[TToken, TSyntaxError, TLabel, T] = this

    override def recoverFailure[U >: T](f: (Chunk[WithSource[TToken]], GrammarResultFailure[TToken, TSyntaxError, TLabel]) => GrammarResult[TToken, TSyntaxError, TLabel, U]): GrammarResult[TToken, TSyntaxError, TLabel, U] =
      this

    override def toEither: Either[NonEmptyChunk[TSyntaxError], (Chunk[WithSource[TToken]], WithSource[T])] = Right((tokens, value))
  }
  ...
  final case class GrammarResultFailure[TToken, TSyntaxError, TLabel[_]](failure: NonEmptyChunk[TSyntaxError])
    ...
    override def map[U](f: (Chunk[WithSource[TToken]], WithSource[Nothing]) => (Chunk[WithSource[TToken]], WithSource[U])): GrammarResultComplete[TToken, TSyntaxError, TLabel, U] = this

    override def flatMap[U](f: (Chunk[WithSource[TToken]], WithSource[Nothing]) => GrammarResult[TToken, TSyntaxError, TLabel, U]): GrammarResult[TToken, TSyntaxError, TLabel, U] = this
    override def flatMap[U](f: (Chunk[WithSource[TToken]], WithSource[Nothing]) => GrammarResultComplete[TToken, TSyntaxError, TLabel, U]): GrammarResultComplete[TToken, TSyntaxError, TLabel, U] = this

    override def treatFailureAsError: GrammarResultComplete[TToken, TSyntaxError, TLabel, Nothing] = GrammarResultError(failure)

    override def recoverFailure[U >: Nothing](f: (Chunk[WithSource[TToken]], GrammarResultFailure[TToken, TSyntaxError, TLabel]) => GrammarResult[TToken, TSyntaxError, TLabel, U]): GrammarResult[TToken, TSyntaxError, TLabel, U] =
      f(Chunk.empty, this)
  ...
  sealed trait GrammarResultSuspend[TToken, TSyntaxError, TLabel[_], +T] extends GrammarResultNonSuccess[TToken, TSyntaxError, TLabel, T] {
    ...
    override def map[U](f: (Chunk[WithSource[TToken]], WithSource[T]) => (Chunk[WithSource[TToken]], WithSource[U])): GrammarResult[TToken, TSyntaxError, TLabel, U] =
    ...
    override def recoverFailure[U >: T](f: (Chunk[WithSource[TToken]], GrammarResultFailure[TToken, TSyntaxError, TLabel]) => GrammarResult[TToken, TSyntaxError, TLabel, U]): GrammarResult[TToken, TSyntaxError, TLabel, U] =
      new GrammarResultSuspend[TToken, TSyntaxError, TLabel, U] {
        override def continue(tokens: NonEmptyChunk[WithSource[TToken]]): GrammarResult[TToken, TSyntaxError, TLabel, U] =
          GrammarResultSuspend.this.continue(tokens).recoverFailure { (tokens2, failure) => f(tokens ++ tokens2, failure) }
  ...
  (grammarErrors: NonEmptyChunk[TSyntaxError])
  : Grammar[TToken, TSyntaxError, TLabel, TResult] =
    RejectGrammar(grammarErrors)

  def parseAll[TToken, E, TSyntaxError, TLabel[_], T]
  ...
  : ZChannel[Any, E, Chunk[WithSource[TToken]], FilePosition, E | TSyntaxError, Chunk[T], FilePosition] =
    ...
    def runParseStepMulti(s: ParseStep, tokens: NonEmptyChunk[WithSource[TToken]], acc: Chunk[T]): IO[TSyntaxError, (ParseStep, Chunk[T])] =
    ...
    def runParseStep(s: ParseStep, tokens: NonEmptyChunk[WithSource[TToken]]): GrammarResult[TToken, TSyntaxError, TLabel, T] =
      s match {
    ...
    def consumeTokens(state: ParseStep)(tokens: Chunk[WithSource[TToken]]): ZChannel[Any, E, Chunk[WithSource[TToken]], FilePosition, TSyntaxError | E, Chunk[T], FilePosition] =
    ...
    def finish(state: ParseStep)(end: FilePosition): ZChannel[Any, Any, Any, Any, TSyntaxError, Chunk[T], FilePosition] =
      state match {
        case _: ParseStepReady.type => ZChannel.succeed(end)
        case ParseStepPartial(suspend) =>
          def parseEnd(result: GrammarResultComplete[TToken, TSyntaxError, TLabel, T], acc: Chunk[T]): ZChannel[Any, Any, Any, Any, TSyntaxError, Chunk[T], FilePosition] =
            result match {
              case GrammarResultSuccess(remaining, WithSource(value, _)) =>
                NonEmptyChunk.fromChunk(remaining) match {
    ...
    def parse(state: ParseStep): ZChannel[Any, E, Chunk[WithSource[TToken]], FilePosition, TSyntaxError | E, Chunk[T], FilePosition] =
  ...
  private final case class RejectGrammar[TToken, TSyntaxError, TLabel[_], T](grammarErrors: NonEmptyChunk[TSyntaxError]) extends Grammar[TToken, TSyntaxError, TLabel, T] {

    override def parseTokens(tokens: NonEmptyChunk[WithSource[TToken]], options: TParseOptions): GrammarResult[TToken, TSyntaxError, TLabel, T] =
  ...
  private final case class EmptyStrGrammar[TToken, TSyntaxError, TLabel[_], T](result: T) extends Grammar[TToken, TSyntaxError, TLabel, T] {
    ...
    override def parseTokens(tokens: NonEmptyChunk[WithSource[TToken]], options: TParseOptions): GrammarResult[TToken, TSyntaxError, TLabel, T] =
      GrammarResultSuccess(tokens, WithSource(result, SourceLocation(tokens.head.location.start, tokens.head.location.start)))
  ...
  (
    ...
    override def parseTokens(tokens: NonEmptyChunk[WithSource[TToken]], options: TParseOptions): GrammarResult[TToken, TSyntaxError, TLabel, T] = {
      ...
      tokens.head match {
        ...
        case token => GrammarResultFailure(NonEmptyChunk(errorFactory.createError(GrammarError.UnexpectedToken(category, token))))
      }
    }
  ...
  (
    ...
    private def nextHandler(valueA: WithSource[A], options: TParseOptions): GrammarResultSuspend[TToken, TSyntaxError, TLabel, T] =
      new GrammarResultSuspend[TToken, TSyntaxError, TLabel, T] {
        override def continue(tokens: NonEmptyChunk[WithSource[TToken]]): GrammarResult[TToken, TSyntaxError, TLabel, T] =
    ...
    : Grammar[TToken, TSyntaxError, TLabel, T] =
      grammars.tail match {
        case ChunkUnCons(grammarsTail) =>
          grammarsTail.tail.foldLeft(apply(grammars.head.value, grammarsTail.head.value)) { (a, b) => apply(a, b.value) }
  ...
  (innerUncached: => Grammar[TToken, TSyntaxError, TLabel, T])
    ...
    override def parseTokens(tokens: NonEmptyChunk[WithSource[TToken]], options: TParseOptions): GrammarResult[TToken, TSyntaxError, TLabel, Chunk[T]] =
      parseInner(tokens, options, Chunk.empty)
    ...
    private def parseInner(tokens: NonEmptyChunk[WithSource[TToken]], options: TParseOptions, items: Chunk[WithSource[T]]): GrammarResult[TToken, TSyntaxError, TLabel, Chunk[T]] =
      inner.parseTokens(tokens, options).flatMap {
        ...
        case (_, item) =>
          new GrammarResultSuspend[TToken, TSyntaxError, TLabel, Chunk[T]] {
            override def continue(tokens: NonEmptyChunk[WithSource[TToken]]): GrammarResult[TToken, TSyntaxError, TLabel, Chunk[T]] =
              parseInner(tokens, options.notLeftRec, items :+ item)

            override def completeResult(pos: FilePosition): GrammarResultComplete[TToken, TSyntaxError, TLabel, Chunk[T]] =
              GrammarResultSuccess(Chunk(), finalItems(items :+ item, pos))
          }
      }
      .recoverFailure { (laterTokens, _) => GrammarResultSuccess(tokens ++ laterTokens, finalItems(items, tokens.head.location.start)) }

    override def parseEnd(pos: FilePosition, options: TParseOptions): GrammarResultComplete[TToken, TSyntaxError, TLabel, Chunk[T]] =
  ...
  private final class MapGrammar[TToken, TSyntaxError, TLabel[_], T, U](innerUncached: => Grammar[TToken, TSyntaxError, TLabel, T], f: GrammarResult[TToken, TSyntaxError, TLabel, T] => GrammarResult[TToken, TSyntaxError, TLabel, U]) extends Grammar[TToken, TSyntaxError, TLabel, U] {
    ...
    override def parseTokens(tokens: NonEmptyChunk[WithSource[TToken]], options: TParseOptions): GrammarResult[TToken, TSyntaxError, TLabel, U] =
  ...
  trait EmbeddedGrammar[TSyntaxError, TTokenA, TLabelA[_], TTokenB, TLabelB[_], T] extends Grammar[TTokenA, TSyntaxError, TLabelA, T] {
    ...
    final override def parseTokens(tokens: NonEmptyChunk[WithSource[TTokenA]], options: TParseOptions): GrammarResult[TTokenA, TSyntaxError, TLabelA, T] = {

      def handleResult(result: GrammarResult[TTokenA, TSyntaxError, TLabelA, TTokenB], acc: Chunk[WithSource[TTokenB]]): GrammarResult[TTokenA, TSyntaxError, TLabelA, T] =
        result match {
          ...
          case result: GrammarResultSuspend[TTokenA, TSyntaxError, TLabelA, TTokenB] =>
            new GrammarResultSuspend[TTokenA, TSyntaxError, TLabelA, T] {
              override def continue(tokens: NonEmptyChunk[WithSource[TTokenA]]): GrammarResult[TTokenA, TSyntaxError, TLabelA, T] =
