...
final case class ExpectedPlatformPlugin(pluginName: String) extends BuildError
final case class InvalidPluginForPlatforms(pluginName: String, platforms: Seq[String]) extends BuildError
